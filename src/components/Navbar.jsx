          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            {currentUser ? (
              ...
              <div className="flex space-x-4">
                <Link to="/login" className="text-gray-500 hover:text-primary-700 px-3 py-2 rounded-md text-sm font-medium">
                  Login
                </Link>
          ...
          {currentUser ? (
            <div className="pt-4 pb-3 border-t border-gray-200">
              ...
              <div className="mt-3 space-y-1">
                ...
                {currentUser.role === 'INSTRUCTOR' && (
                  <Link to="/instructor" className="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100">
                    Instructor Dashboard
                  </Link>
                )}
                <button
            ...
            <div className="pt-4 pb-3 border-t border-gray-200">
              <div className="flex items-center justify-around">
                <Link to="/login" className="text-gray-500 hover:text-primary-700 px-3 py-2 rounded-md text-base font-medium">
                  Login
                </Link>
                <Link to="/register" className="bg-primary-600 text-white hover:bg-primary-700 px-3 py-2 rounded-md text-base font-medium">
                  Register
                </Link>
              </div>
            </div>
